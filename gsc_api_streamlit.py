...
st.set_page_config(
    layout=layout, page_title="Google Search Console API Explorer", page_icon="https://iconarchive.com/download/i79580/martz90/hex/files.ico"
)
...
if 'verified_sites_urls' in st.session_state:
    with tab3:
        ...
        st.text_input("Copy Countries", "|".join(external_country_selector))
        st.info(
                    f"""
